...
- セッション層  
アプリケーション間でのセッションの確立・維持・終了するまでの手順を規定している。1つのコンピュータ上でWebブラウザとメーラーを起動させて通信しているとする。セッション層で、Webブラウザで送受信しているデータをメーラで送受信しないように、各アプリケーション同士の論理的な経路(セッション)を制御している。セッションが確立するとデータ転送が可能な状態になる
